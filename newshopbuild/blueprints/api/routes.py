...
#internal imports 
from newshopbuild.models import Customer, Product, ProdOrder, Order, db, product_schema, products_schema 
...
## May not need as (product_schema) is changing object to dictionary
    return jsonify(data)
